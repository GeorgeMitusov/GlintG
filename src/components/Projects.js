    ...
    >
      ...
      >
        <div className="projects-portfolio-item-image-overlay-icon-wrap">
          ...
          >
            <FontAwesomeIcon
              className="projects-portfolio-item-image-overlay-icon"
              icon={faLink}
            />
  ...
  return (
    <section className="projects" id="works">
      ...
      <motion.div
        ...
        animate={controls}
      >
        <motion.div className="projects-header" variants={itemA}>
          <h3> RECENT WORKS </h3>
          <h1>
            {" "}
        ...
        <motion.div className="projects-portfolio" variants={itemA}>
          <LightGallery
            // onInit={onInit}
            speed={500}
